...
int main()
{
	...
	for(int i = 0;i < numEmployees;i++)
	{
		...
		cout<<"Enter Mobile: \n	";
		cin>>employees[i].con.mobile;
		cout<<"Enter email, personal web: \n";
		cin>>employees[i].con.email;
		cin>>employees[i].con.personalWeb;
	}
...
void printEes(Employee employees[], int size)
{
	for(int i = 0; i < size; i++)
	{
		...
		cout<<"mobile: ";
		cout<<employees[i].con.mobile<<",\n epost: "<<employees[i].con.email<<",\n web: "<<employees[i].con.personalWeb<<endl;
	}
}
